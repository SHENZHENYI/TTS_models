...
class Preprocessor:
    def __init__(self, config):
        ...
        assert config.pitch_feature in [
            "phoneme_level",
            "frame_level",
        ]
        assert config.energy_feature in [
            "phoneme_level",
            "frame_level",
        ]
        self.pitch_phoneme_averaging = (
            config.pitch_feature == "phoneme_level"
        )
        self.energy_phoneme_averaging = (
            config.energy_feature == "phoneme_level"
        )

        self.pitch_normalization = config.pitch_norm
        self.energy_normalization = config.energy_norm
